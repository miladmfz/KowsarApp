...
public class Ocr_Collect_ListApi_Adapter extends RecyclerView.Adapter<Ocr_Collect_ListApi_Adapter.facViewHolder> {
    ...
    public Ocr_Collect_ListApi_Adapter(ArrayList<Factor> retrofitFactors, String State, Context context) {
    ...
    @NonNull
    @Override
    public Ocr_Collect_ListApi_Adapter.facViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ocr_collect_listapi_card, parent, false);
        return new Ocr_Collect_ListApi_Adapter.facViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final Ocr_Collect_ListApi_Adapter.facViewHolder holder, final int position) {
    ...
    static class facViewHolder extends RecyclerView.ViewHolder {
        ...
        facViewHolder(View itemView) {
            ...
            fac_customer = itemView.findViewById(R.id.ocr_collect_listapi_c_customer);
            fac_customercode = itemView.findViewById(R.id.ocr_collect_listapi_c_customercode);
            fac_factor_explain_ll = itemView.findViewById(R.id.ocr_collect_listapi_c_ll_explain);
            fac_factor_state_ll = itemView.findViewById(R.id.ocr_collect_listapi_c_ll_state);
            fac_stackclass = itemView.findViewById(R.id.ocr_collect_listapi_c_stackclass);

            fac_ocrexplain = itemView.findViewById(R.id.ocr_collect_listapi_c_ocrexplain);
            fac_factor_ocrexplain_ll = itemView.findViewById(R.id.ocr_collect_listapi_c_ll_ocrexplain);

            fac_code = itemView.findViewById(R.id.ocr_collect_listapi_c_privatecode);
            fac_hasedite = itemView.findViewById(R.id.ocr_collect_listapi_c_hasedited);
            fac_hasshortage = itemView.findViewById(R.id.ocr_collect_listapi_c_hasshortage);
            fac_kowsardate = itemView.findViewById(R.id.ocr_collect_listapi_c_kowsardate);
            fac_state = itemView.findViewById(R.id.ocr_collect_listapi_c_state);
            fac_factor_btn = itemView.findViewById(R.id.ocr_collect_listapi_c_btn);
            fac_explain = itemView.findViewById(R.id.ocr_collect_listapi_c_explain);
            fac_rltv_ll = itemView.findViewById(R.id.ocr_collect_listapi_c_ll_main);

            fac_rltv = itemView.findViewById(R.id.ocr_collect_listapi_card);
        }
    }
