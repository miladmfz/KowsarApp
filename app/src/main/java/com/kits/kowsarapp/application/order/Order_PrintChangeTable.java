...
public class Order_PrintChangeTable {
                        ...
                        public void onResponse(@NotNull Call<RetrofitResponse> call, @NotNull Response<RetrofitResponse> response) {
                            if (response.isSuccessful()) {
                                ...
                                if (response.body().getText().equals("Done")) {
                                    order_print.GetHeader_Data("MizType");
                                }
    ...
    public void GetHeader_Data(String Filter, Order_BasketInfo basketInfo) {
        Filter_print = Filter;
        ...
        if (basketInfo.getMizType().equals(callMethod.ReadString("MizType"))) {
            callMethod.showToast(mContext.getString(com.kits.kowsarapp.R.string.textvalue_recorded));
            dialogProg.dismiss();
            DoPrint();
        } else {
    ...
    public void CreateView() {
        ...
        for (Factor FactorRow_detail : Factor_row) {
            ...
            good_amount_tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, Integer.parseInt(callMethod.ReadString("TitleSize")) + 5);
